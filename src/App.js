...
function App() {
  ...
  useEffect(() => {
    ...
    const authenticateData = async () => {
      try {
        const response = await axios.post('https://telegram-mini-app-aa-backend-deploy.azurewebsites.net/authenticate', { initData });
  ...
  const getNFTs = async () => {
    try {
      ...
      const response = await axios.post('https://telegram-mini-app-aa-backend-deploy.azurewebsites.net/getNFTs', { initData });
      console.log(response.data);
  ...
  const mint = async () => {
    try {
      ...
      const response = await axios.post('https://telegram-mini-app-aa-backend-deploy.azurewebsites.net/mint', { initData });
      console.log(response.data);
  ...
  const transfer = async () => {
    try {
      ...
      const response = await axios.post('https://telegram-mini-app-aa-backend-deploy.azurewebsites.net/transfer', { initData, tokenId, toAddress });
      console.log(response.data);
      const { transactionHash } = response.data;
      const txLink = `https://sepolia.basescan.org/tx/${transactionHash}`;
      setPopupContent({
